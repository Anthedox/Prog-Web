	...
	<div class="modal-body">	
		...
		<div class="row">
			<div class="col-xs-12 text-left form">
				...
				<input id="txtNombre" type="text" maxlength="50" onkeypress="return validartexto(event)">
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-12 text-left form">
				...
				<input id="txtCorreo" type="text"  maxlength="30" placeholder="ejemplo@correo.com">
				<button type="button" class="btn btn-success btnregistrar" onclick="validarcorreo()"><span class="glyphicon glyphicon-ok "></span></button>
			</div>
		</div>	
		...
		<div class="row">
			<div class="col-xs-12 text-left form">
				...
				<input id="txtTelefono" type="text" maxlength="20" onkeypress="return validarcodigo(event)">
			</div>
		</div>	
